...
INSERT OR IGNORE INTO students (student_id, user_id, name, email, teacher_id, academic_advisor_id, birthday, high_school, language_school, jlpt_score, eju_scores, english_score, package_name, package_end_date, tags, subject, has_account) VALUES
  ...
  ('2024002', 'student2', '李四', 'lisi@student.jsa.com', 'teacher_1', 'teacher_6', '2002-01-20', '上海外国语学校', '大阪日本语学校', 'N2-120', '[]', '', '校内考专家 1（原 1+2）', '2026-03-31', '["文科"]', '文科', 1),
  ('2024003', 'student3', '王五', 'wangwu@student.jsa.com', 'teacher_2', 'teacher_7', '2000-11-03', '广州执信中学', '京都国际学院', 'N1-158', '[{"date":"2025-06","japanese":340,"math":190,"science":160,"total":690}]', 'TOEIC 780', '丁老师规划 1+2（原 1+2+3）', '2027-03-31', '["理科","优秀学生"]', '理科', 1),
  ('2024004', 'student4', '赵六', 'zhaoliu@student.jsa.com', 'teacher_2', 'teacher_7', '2001-08-15', '成都七中', '名古屋日本语学院', 'N2-105', '[{"date":"2025-06","japanese":280,"math":120,"science":0,"total":400}]', '', '校内考专家 1+2（原 1+2+3）', '2026-09-30', '["文科","需加强"]', '文科', 1),
  ('2024005', 'student5', '刘七', 'liuqi@student.jsa.com', 'teacher_3', 'teacher_6', '2000-03-28', '杭州学军中学', '早稻田日本语学校', 'N1-170', '[{"date":"2025-06","japanese":355,"math":195,"science":170,"total":720}]', 'TOEFL 95', '丁老师规划 1（原 1+2）', '2026-08-31', '["理科","优秀学生","即将毕业"]', '理科', 1),
  ...
  ('2024008', 'student8', '吴十', 'wushi@student.jsa.com', 'teacher_4', '', '2003-09-01', '南京外国语学校', '神户日本语学校', '', '[]', '', '校内考专家 1（原 1+2）', '2026-12-31', '["文科","新生","需加强"]', '文科', 1),
  ('2024009', 'student9', '郑十一', 'zheng11@student.jsa.com', 'teacher_2', 'teacher_6', '1999-07-14', '重庆南开中学', '大阪国际学院', 'N1-165', '[{"date":"2025-06","japanese":350,"math":185,"science":165,"total":700}]', 'TOEFL 100', '丁老师规划 1+2（原 1+2+3）', '2025-12-31', '["理科","已合格"]', '理科', 1),
