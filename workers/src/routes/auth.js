...
auth.post('/init-seed', async (c) => {
  ...
  try {
    ...
    const studentsToCreate = [
      ...
      { studentId: '2024002', userId: 'student2', name: '李四', email: 'lisi@student.jsa.com', teacherId: 'teacher_1', advisorId: 'teacher_6', birthday: '2002-01-20', highSchool: '上海外国语学校', langSchool: '大阪日本语学校', jlpt: 'N2-120', eju: '[]', english: '', pkg: '校内考专家 1（原 1+2）', pkgEnd: '2026-03-31', tags: '["文科"]', subject: '文科', hasAccount: 1 },
      { studentId: '2024003', userId: 'student3', name: '王五', email: 'wangwu@student.jsa.com', teacherId: 'teacher_2', advisorId: 'teacher_7', birthday: '2000-11-03', highSchool: '广州执信中学', langSchool: '京都国际学院', jlpt: 'N1-158', eju: '[{"date":"2025-06","japanese":340,"math":190,"science":160,"total":690}]', english: 'TOEIC 780', pkg: '丁老师规划 1+2（原 1+2+3）', pkgEnd: '2027-03-31', tags: '["理科","优秀学生"]', subject: '理科', hasAccount: 1 },
      { studentId: '2024004', userId: 'student4', name: '赵六', email: 'zhaoliu@student.jsa.com', teacherId: 'teacher_2', advisorId: 'teacher_7', birthday: '2001-08-15', highSchool: '成都七中', langSchool: '名古屋日本语学院', jlpt: 'N2-105', eju: '[{"date":"2025-06","japanese":280,"math":120,"science":0,"total":400}]', english: '', pkg: '校内考专家 1+2（原 1+2+3）', pkgEnd: '2026-09-30', tags: '["文科","需加强"]', subject: '文科', hasAccount: 1 },
      { studentId: '2024005', userId: 'student5', name: '刘七', email: 'liuqi@student.jsa.com', teacherId: 'teacher_3', advisorId: 'teacher_6', birthday: '2000-03-28', highSchool: '杭州学军中学', langSchool: '早稻田日本语学校', jlpt: 'N1-170', eju: '[{"date":"2025-06","japanese":355,"math":195,"science":170,"total":720}]', english: 'TOEFL 95', pkg: '丁老师规划 1（原 1+2）', pkgEnd: '2026-08-31', tags: '["理科","优秀学生","即将毕业"]', subject: '理科', hasAccount: 1 },
      ...
      { studentId: '2024008', userId: 'student8', name: '吴十', email: 'wushi@student.jsa.com', teacherId: 'teacher_4', advisorId: 'teacher_7', birthday: '2003-09-01', highSchool: '南京外国语学校', langSchool: '神户日本语学校', jlpt: '', eju: '[]', english: '', pkg: '校内考专家 1（原 1+2）', pkgEnd: '2026-12-31', tags: '["文科","新生","需加强"]', subject: '文科', hasAccount: 1 },
      { studentId: '2024009', userId: 'student9', name: '郑十一', email: 'zheng11@student.jsa.com', teacherId: 'teacher_2', advisorId: 'teacher_6', birthday: '1999-07-14', highSchool: '重庆南开中学', langSchool: '大阪国际学院', jlpt: 'N1-165', eju: '[{"date":"2025-06","japanese":350,"math":185,"science":165,"total":700}]', english: 'TOEFL 100', pkg: '丁老师规划 1+2（原 1+2+3）', pkgEnd: '2025-12-31', tags: '["理科","已合格"]', subject: '理科', hasAccount: 1 },
